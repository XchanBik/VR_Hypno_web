...
export const VolumeIcon = `
  <svg class="w-full h-full" viewBox="0 0 20 20" fill="currentColor">
    <path fill-rule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.617.774L4.586 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.586l3.797-3.774a1 1 0 011.617.774zM15.657 6.343a1 1 0 011.414 0A9.972 9.972 0 0119 12a9.972 9.972 0 01-1.929 5.657 1 1 0 11-1.414-1.414A7.971 7.971 0 0017 12c0-2.21-.896-4.208-2.343-5.657a1 1 0 010-1.414z" clip-rule="evenodd"/>
  </svg>
`;
